<?php $page_title = "search featured"; ?>
...
<main role="main" id="main" class="container">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="search_featured.php">Search Results</a></li>
		</ol>
	</div><!-- .row -->
	...
	<div class="eventHeader row">
		...
		<form action="search_featured.php" method="GET" class="col-sm-4">
			<div class="input-group">
				<input type="search" name="q" class="form-control" placeholder="Search for Featured Events">
