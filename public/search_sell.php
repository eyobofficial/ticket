...
<main role="main" id="main" class="container">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li><a href="sell.php">Sell Tickets</a></li>
			<li class="active"><a href="search_sell.php">Search Results</a></li>
		</ol>
	</div><!-- .row -->
	...
	<div class="eventHeader row">
		...
		<form action="search_sell.php" method="GET" class="col-sm-4">
			<div class="input-group">
				<input type="search" name="q" class="form-control" placeholder="Search for Your Ticket&apos;s Event">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="row">
				...
				<?php include_once("layout/search_sell.layout.php"); ?>
			</div><!-- .row -->
