<?php $page_title = "search festivals"; ?>
...
<main role="main" id="main" class="container">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="search_feastivals.php">Search Results</a></li>
		</ol>
	</div><!-- .row -->
	...
	<div class="eventHeader row">
		...
		<form action="search_festivals.php" method="GET" class="col-sm-4">
			<div class="input-group">
				<input type="search" name="q" class="form-control" placeholder="Search for Festival Events">
