...
<div class="checkoutSummaryTicket">
	<ul class="list-unstyled">
		...
		<li class="subtotal"><b>TOTAL</b>  <span class="pull-right"><b><?php echo $currency->code; ?> <?php echo $currency->convert($total); ?></b></span></li>
	</ul>
	<p class="footnote"><span class="fa fa-exclamation-circle"></span> Price does NOT include VAT<?php echo isset($delivery_method_id) ? '' : ' and delivery'; ?>.</p>
