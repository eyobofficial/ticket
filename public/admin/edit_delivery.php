		...
		<section class="col-sm-10" id="adminMain">
			<div class="row">
				<section class="col-sm-8">
					...
					<header>
						<h2 class="h4 text-left actionTitle"><span class="fa fa-user"></span> Edit Delivery Method</h1>
					</header>
					...
					<form action="edit_delivery.php?delivery_id=<?php echo htmlentities($delivery->id); ?>" method="POST" name="add_admin" id="addAdmin">
