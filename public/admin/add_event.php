		...
		<section class="col-sm-10" id="adminMain">
			<div class="row">
				<section class="col-sm-8">
					...
					<header>
						<h2 class="h4 text-left actionTitle">Add New Event</h1>
					...
					<form action="add_event.php" name="add_event" id="addEvent" method="POST" enctype="multipart/form-data">
						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="col-sm-12" id="eventSummary">
									<!-- Name -->
									<div class="form-group">
										<label for="name" class="sr-only">Name:</label>
										<input type="text" name="name" id="name" value="<?php echo $event_name; ?>" placeholder="Event Name" class="form-control">
									</div><!-- .form-group -->

									<!-- Venue -->
									<div class="form-group">
										<label for="venue" class="sr-only">Venue: </label>
										<input type="text" name="venue" id="venue" class="form-control" placeholder="venue" value="<?php echo htmlentities($event_venue); ?>">
									</div><!-- .form-group -->

									<!-- City -->
									<div class="form-group">
										<label for="city" class="sr-only">City: </label>
										<input type="text" name="city" id="city" class="form-control" placeholder="City" value="<?php echo htmlentities($event_city); ?>">
									</div><!-- .form-group -->
										...
										<div class="date form-group">
											...
											<select name="date" id="date" class="form-control">
												...
												<?php for($date = 1; $date <= 31; $date++): ?>
													<option value="<?php echo $date; ?>"><?php echo sprintf("%02d", $date); ?></option>
												<?php endfor; ?>
											</select> 
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<textarea name="overview" id="overview" cols="30" rows="10" placeholder="Short descripition about the event." class="form-control"> <?php if(!empty($overview)){echo ucfirst(strtolower(htmlentities($overview)));} ?></textarea>
									</div>
								</div>
									...
									<div class="table-responsive">
										<table class="table table-bordered table-condensed table-hover" id="addTicketTable">
											...
											<tbody>
												<tr>
													<td>
														<input type="text" name="package_title[]" id="packageTitle1" placeholder="Ticket Package" class="form-control">
													</td>
				...
				<section class="col-sm-4" id="sideActions">
					...
					<div class="event-photo-container">
						<h4><span class="fa fa-upload"></span> Upload Event Photo</h4>
					...
					<div class="event-photo-container">
						<h4><span class="fa fa-upload"></span> Upload Ticket Sitting Photo</h4>
					...
					<div class="side-action-container">
						...
						<div class="actionSection visibleSection">
							...
							<div class="radio">
								<label>
									<input type="radio" name="visible" value=1 checked="checked"> <span>Show</span>
								</label>
							</div>

							<div class="radio">
								<label>
									<input type="radio" name="visible" value=0> <span>Hide</span>
								</label>
							</div>
						</div><!-- .actionSection -->
						...
						<div class="actionSection featuredSection">
							...
							<div class="radio">
								<label>
									<input type="radio" name="featured" value=1> <span>Yes</span>
								</label>
							</div>

							<div class="radio">
								<label>
									<input type="radio" name="featured" value=0 checked="checked"> <span>No</span>
								</label>
							</div>
						</div><!-- .actionSection -->
						
						<div class="actionSectionFooter">
							<a href="#" title="preview" class="btn btn-default" target="_blank" disabled="disabled">
								Preview&nbsp;
							</a>
