		...
		<section class="col-sm-10" id="adminMain">
			<div class="row">
				<section class="col-sm-8">
					...
					<header>
						<h2 class="h4 text-left actionTitle"><span class="fa fa-envelope"></span> Contact Superadmin</h1>
					</header>
					...
					<form action="send_admin.php?user_id=<?php echo htmlentities($user_id); ?>" method="POST" name="add_admin" id="addAdmin">
